...
const Experience = () => {
  return (
    <section id='experience' className='border-b border-neutral-800 py-20'>
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className='hidden sm:flex flex-col items-center'>
                <div className='w-10 h-10 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shrink-0 z-10 shadow-lg shadow-purple-900/40'>
              ...
              <div className='flex-1 rounded-xl border border-neutral-800 bg-neutral-900/50 p-6'>
                ...
                <p className='mt-3 text-sm text-neutral-400 leading-relaxed'>{exp.description}</p>
